...
public class Switch : MonoBehaviour
{
    ...
    [Range(0.1f, 0.6f)]
    public float minAlphaValue = 0.2f;//靠后图片最小透明度
    ...
    IEnumerator MoveRight()
    {
        ...
        {
            Vector3 targetPos = itemRectTransforms[(i + itemRectTransforms.Length - 1) % itemRectTransforms.Length].anchoredPosition3D;
    ...
    IEnumerator MoveToTargetPos(RectTransform rectTrans, Vector3 targetPos)
    {
        ...
        {
            rectTrans.anchoredPosition3D = Vector3.MoveTowards(rectTrans.anchoredPosition3D, targetPos, speed * Time.deltaTime);
